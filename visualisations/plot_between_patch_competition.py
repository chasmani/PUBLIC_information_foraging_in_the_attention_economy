...
def plot_patch_choice_low_prev(ax, seed=11, im_count=10):
	...
	icon_file_book = "resources/002-open-book.png"
	icon_file_news = "resources/001-newspaper.png"
	...
	sns.lineplot(xx,yy, color=COLOR_3, linestyle="dashed", linewidth=3)
...
def plot_patch_choice_high_prev(ax, seed=3, im_count=20, lamb=2):
	...
	icon_file_book = "resources/002-open-book.png"
	icon_file_news = "resources/001-newspaper.png"
	icon_file_twitter = "resources/006-twitter.png"
