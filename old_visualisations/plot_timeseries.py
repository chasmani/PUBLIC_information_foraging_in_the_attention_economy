...
def plot_coha_timeseries(measure="H_1", measure_name="Word Entropy", invert_axis=False):
	...
	plt.tight_layout()
	plt.savefig("images/timeseries_with_ci_{}.tiff".format(measure), format="tiff", dpi=300)
